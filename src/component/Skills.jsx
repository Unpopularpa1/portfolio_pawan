  ...
  const skillCategories = {
    development: {
      ...
      skills: [
        ...
        { name: "ReactJs", level: 70, icon: Code2 },
      ...
      skills: [
        ...
        { name: "GraphQL", level: 40, icon: Cpu },
        { name: "REST API", level: 50, icon: Server },
        { name: "Express.js", level: 50, icon: Server },
      ],
    },
    tools: {
      title: "Tools",
      description: "tools I'm familiar with",
      icon: Wrench,
      color: "amber",
      skills: [
        { name: "Git", level: 70, icon: GitBranch },
        { name: "Vercel", level: 50, icon: Server },
        { name: "Figma", level: 60, icon: Layout },
